...
if TYPE_CHECKING:
    ...
    from budget_analyser.features.budget_goals.models import BudgetProgress
...
class BudgetGoalsPage(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        budget_controller: "BudgetGoalsController",
    ...
    def _populate_months(self) -> None:
        ...
        def _set_month_options(combo: QtWidgets.QComboBox) -> None:
            ...
            for m in self._months:
                combo.addItem(format_year_month(m), m)
            if self._months:
        ...
        for i, name in enumerate(MONTH_NAMES_SHORT):
            self._manage_month_combo.addItem(name, i + 1)
    ...
    def _refresh_budget_progress(self) -> None:  # pylint: disable=too-many-locals
    ...
    def _refresh_earnings_table(self) -> None:  # pylint: disable=too-many-locals
    ...
    def _refresh_manage_tables(self) -> None:
        ...
        selected_month = self._manage_month_combo.currentData()
