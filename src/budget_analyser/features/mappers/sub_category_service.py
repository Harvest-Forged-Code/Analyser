...
class SubCategoryMapperService:
    """Service to manage sub-category assignments.
    ...
    def __init__(
        ...
        """Initialize the sub-category mapper service.
    ...
    def add_sub_category(
        ...
        Example:
            >>> svc.add_sub_category("Dining Out", "Food")
        """
    ...
    def save(self) -> None:
        ...
        Example:
            >>> svc.add_sub_category("Snacks", "Food")
            >>> svc.save()
        """
...
SubCategoryMapperController = SubCategoryMapperService
