...
class CashflowMapperService:
    """Service to edit earnings/expenses category grouping.
    ...
    def __init__(
        ...
        """Initialize the cashflow mapper service.
    ...
    def add_category(self, name: str, flow: str) -> None:
        ...
        Example:
            >>> svc.add_category("Side Hustle", "earnings")
        """
        val = (name or "").strip()
        if not val:
    ...
    def move_to_earnings(
        ...
        Example:
            >>> svc.move_to_earnings(["Freelance"])
        """
    ...
    def move_to_expenses(
        ...
        Example:
            >>> svc.move_to_expenses(["Misc Income"])
        """
    ...
    def save(self) -> None:
        ...
        Example:
            >>> svc.add_category("Bonus", "earnings")
            >>> svc.save()
        """
...
CashflowMapperController = CashflowMapperService
