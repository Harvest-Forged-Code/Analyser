...
class EarningsStatsService:  # pylint: disable=too-many-public-methods
    """Service to compute Earnings page data.
    ...
    def __init__(
        ...
        """Initialize the earnings statistics service.
    ...
    def month_label(period: pd.Period) -> str:
        ...
        Example:
            >>> EarningsStatsService.month_label(
    ...
    def table_for_month(
        ...
        Example:
            >>> rows, actual, expected = svc.table_for_month(
            ...     pd.Period("2024-01", "M"),
            ... )
            >>> len(rows)
            3
    ...
    def table_for_year(
        ...
        Example:
            >>> rows, actual, expected = svc.table_for_year(
            ...     2024,
            ... )
            >>> actual
            62400.0
    ...
    def table_for_range(
        ...
        Example:
            >>> from datetime import date
            >>> rows, actual, expected = svc.table_for_range(
    ...
    def subcategory_totals_for_range(
        ...
        Example:
            >>> from datetime import date
            >>> totals = svc.subcategory_totals_for_range(
            ...     date(2024, 1, 1), date(2024, 6, 30),
            ... )
            >>> totals[0]
            ('Salary', 30000.0)
    ...
    def dashboard(self, period: pd.Period) -> EarningsDashboard:
        ...
        Example:
            >>> dash = svc.dashboard(pd.Period("2026-02", "M"))
    ...
    def monthly_trend(
        ...
        Example:
            >>> trend = svc.monthly_trend(months=6)
            >>> len(trend)
            6
        """
    ...
    def source_trend(
        ...
        Example:
            >>> trends = svc.source_trend(months=6)
...
EarningsStatsController = EarningsStatsService
