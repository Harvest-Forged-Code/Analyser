...
\begin{itemize}
    ...
    \item \textbf{docs/}: LaTeX manual and UML diagrams
...
The class diagram is defined in the \texttt{class\_diagram.puml} file located in the \texttt{docs/uml/} directory. To generate a visual representation of this diagram, you can use one of the following methods:
...
The sequence diagrams are defined in the \texttt{data\_processing\_sequence.puml} and \texttt{ui\_flow\_sequence.puml} files located in the \texttt{docs/uml/} directory. To generate visual representations of these diagrams, you can use the same methods as for the class diagram:
